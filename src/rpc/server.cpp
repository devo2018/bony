...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BONY features */
        {"bony", "masternode", &masternode, true, true, false},
        {"bony", "listmasternodes", &listmasternodes, true, true, false},
        {"bony", "getmasternodecount", &getmasternodecount, true, true, false},
        {"bony", "masternodeconnect", &masternodeconnect, true, true, false},
        {"bony", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"bony", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"bony", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"bony", "masternodecurrent", &masternodecurrent, true, true, false},
        {"bony", "masternodedebug", &masternodedebug, true, true, false},
        {"bony", "startmasternode", &startmasternode, true, true, false},
        {"bony", "createmasternodekey", &createmasternodekey, true, true, false},
        {"bony", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"bony", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"bony", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"bony", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"bony", "getmasternodescores", &getmasternodescores, true, true, false},
        {"bony", "mnbudget", &mnbudget, true, true, false},
        {"bony", "preparebudget", &preparebudget, true, true, false},
        {"bony", "submitbudget", &submitbudget, true, true, false},
        {"bony", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"bony", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"bony", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"bony", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"bony", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"bony", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"bony", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"bony", "checkbudgets", &checkbudgets, true, true, false},
        {"bony", "mnsync", &mnsync, true, true, false},
        {"bony", "spork", &spork, true, true, false},
        {"bony", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzbonseed", &getzbonseed, false, false, true},
        {"zerocoin", "setzbonseed", &setzbonseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzbon", &searchdzbon, false, false, true},
        {"zerocoin", "dzbonstate", &dzbonstate, false, false, true}
...
{
    return "> bony-cli " + methodname + " " + args + "\n";
}
