...
extern UniValue setzbonseed(const UniValue& params, bool fHelp);
extern UniValue getzbonseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzbon(const UniValue& params, bool fHelp);
extern UniValue dzbonstate(const UniValue& params, bool fHelp);
