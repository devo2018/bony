                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzBONPathCustom = GetArg("-zbonbackuppath", "");
    ...
    if(!strzBONPathCustom.empty()) {
        ui->wallet_customzbonbackuppath->setText(QString::fromStdString(strzBONPathCustom));
        ui->wallet_customzbonbackuppath_label->setVisible(true);
        ui->wallet_customzbonbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzBONPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the BONY RPC console.") + "<br>" +
