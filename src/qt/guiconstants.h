...
/* Bony GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "BONY"
#define QAPP_ORG_DOMAIN "bony.org"
#define QAPP_APP_NAME_DEFAULT "BONY-Qt"
#define QAPP_APP_NAME_TESTNET "BONY-Qt-testnet"
