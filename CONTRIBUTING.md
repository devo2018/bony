Contributing to BONY Core
============================

The BONY Core project operates an open contributor model where anyone is
...
The following applies to code changes to the BONY Core project, and is not to be
confused with overall BONY Network Protocol consensus changes.

Whether a pull request is merged into BONY Core rests with the project merge
...
Patches that change BONY consensus rules are considerably more involved than
...
Where a patch set proposes to change the BONY consensus, it must have been
...
The project leader is the release manager for each BONY Core release.
