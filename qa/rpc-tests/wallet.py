...
#   c) node1 mines 32 blocks, so now node 0 has 60001bon, node 1 has 4250bon, node2 has none.
#   d) node0 sends 601 bon to node2, in two transactions (301 bon, then 300 bon).
