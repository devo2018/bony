...
In order to support loading of multiple wallets in bony-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bony.cpp.
...
Changes to bony.cpp
----------------------
bony.cpp is the entry point into bony-qt, and as such, will require some minor modifications to provide hooks for
