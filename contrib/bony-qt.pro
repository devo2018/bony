...
RESOURCES += src/qt/bony.qrc src/qt/bony_locale.qrc

TRANSLATIONS += src/qt/locale/bony_bg.ts \
                src/qt/locale/bony_de.ts \
                src/qt/locale/bony_en.ts \
                src/qt/locale/bony_es.ts \
                src/qt/locale/bony_fi.ts \
                src/qt/locale/bony_fr.ts \
                src/qt/locale/bony_it.ts \
                src/qt/locale/bony_ja.ts \
                src/qt/locale/bony_pl.ts \
                src/qt/locale/bony_pt.ts \
                src/qt/locale/bony_ru.ts \
                src/qt/locale/bony_sk.ts \
                src/qt/locale/bony_sv.ts \
                src/qt/locale/bony_vi.ts \
                src/qt/locale/bony_zh_CN.ts \
                src/qt/locale/bony_zh_TW.ts
